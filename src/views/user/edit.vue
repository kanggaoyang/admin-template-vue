    ...
    methods: {
      getDetail(id) {
        detail({ id } ).then((res) => {
          ...
          const { name,email,sex,password,all_pic,pic } = result
          if (code === 200) {
            ...
            this.formLabelAlign.all_pic = this.imageUrl = all_pic
            this.formLabelAlign.pic = this.pic
          }
        })
      },
      back() {
      ...
      submitForm(formName) {
        ...
        this.formLabelAlign = {...this.formLabelAlign, ...{id: this.id}};
